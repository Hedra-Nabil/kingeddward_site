...
<?php $title='King Edward Travel — All for Egypt | Nile Cruises & Egypt Tours Since 2005'?>
   ...
   <?php include './parts/mobile-menu.php'?>       
        ...
        <section class="banner">
            <div class="banner-icon1">
                <img src="static.php?file=assets/images/icons/banner-icon-01.png" alt="icon">
            </div>
            <div class="banner-icon2">
                <img src="static.php?file=assets/images/icons/banner-icon-02.png" alt="icon">
            </div>
            <div class="pattern-layer" style="background-image: url(static.php?file=assets/images/shape/map.png);"></div>
                                    ...
                                    <div class="banner-content">
                                        <div class="banner-content-wrapper">
                                            <div class="banner-content-wrapper-inner">
                                                ...
                                                <p>Official agency since 2005 (License 1311). Nile cruises, Cairo, Luxor, Aswan & Red Sea tours with our own A/C fleet and expert tour managers.</p>
                                                <div class="banner-btn-media">
                                                    <div class="header-link-btn"><a class='btn-1' href='tour-package.php'> Book Now<span></span></a></div>
                            ...
                            <div class="col-lg-6">
                                <div class="banner-right-content">
                                    <div class="banner-right-image">
                                        <img src="static.php?file=assets/images/egypt/pyramids-giza.jpg" alt="banner-two-image">
                                    </div>
                                    <div class="border-image">
                                        <img src="static.php?file=assets/images/shape/border-image.png" alt="border">
                                    </div>
                                    <div class="banner-plane">
                                        <img src="static.php?file=assets/images/shape/banner-plan.png" alt="plan">
                                    </div>
                                    <div class="banner-car">
                                        <img src="static.php?file=assets/images/shape/banner-car.png" alt="car">
                                    </div>
                                    <div class="banner-vedio">
                                        <div class="banner-vedio-image">
                                            <img src="static.php?file=assets/images/egypt/luxor-balloon.jpg" alt="">
                                            <div class="missiom-video-btn">
                                                <a href="https://www.youtube.com/watch?v=pQcUU-g3c48" target="_blank" class="hv-popup-link"><i class="fas fa-play"></i></a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="banner-track">
                                        ...
                                        <div class="banner-track-image">
                                            <img src="static.php?file=assets/images/egypt/nile-cruise.jpg" alt="img">
                                            <div class="banner-track-shape">
                                                <img src="static.php?file=assets/images/shape/banner-track-shape.png" alt="tracker">
                                                <div class="location">
        ...
        <section class="service">
            ...
            <div class="service-icon3">
                <img src="static.php?file=assets/images/icons/s-3.png" alt="icon">
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
        ...
        <section class="category">
            <div class="sail-image">
                <img src="static.php?file=assets/images/shape/sail.png" alt="shape">
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                            ...
                            <div class="category-content-inner">
                                <div class="category-image-container">
                                    <div class="category-image">
                                        <img src="static.php?file=assets/images/icons/c-1.png" alt="icon">
                                    </div>
                                </div>
                                <h5>Cairo & Giza</h5>
                                <span>Egypt Tours</span>
                                <a class='category-btn' href='destination-details.php'><i class="fa-solid fa-angle-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-4 col-md-6">
                        <div class="category-content wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1200ms">
                            <div class="category-content-inner">
                                <div class="category-image-container">
                                    <div class="category-image">
                                        <img src="static.php?file=assets/images/icons/c-2.png" alt="icon">
                                    </div>
                                </div>
                                <h5>Nile Cruises</h5>
                                <span>Egypt Tours</span>
                    ...
                    <div class="col-xl-2 col-lg-4 col-md-6">
                        <div class="category-content wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1400ms">
                            <div class="category-content-inner">
                                <div class="category-image-container">
                                    <div class="category-image">
                                        <img src="static.php?file=assets/images/icons/c-3.png" alt="icon">
                                    </div>
                                </div>
                                <h5>Red Sea & Sinai</h5>
                                <span>Egypt Tours</span>
                    ...
                    <div class="col-xl-2 col-lg-4 col-md-6">
                        <div class="category-content wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1600ms">
                            <div class="category-content-inner">
                                <div class="category-image-container">
                                    <div class="category-image">
                                        <img src="static.php?file=assets/images/icons/c-4.png" alt="icon">
                                    </div>
                                </div>
                                <h5>Luxor & Aswan</h5>
                                <span>Egypt Tours</span>
                    ...
                    <div class="col-xl-2 col-lg-4 col-md-6">
                        <div class="category-content wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1800ms">
                            <div class="category-content-inner">
                                <div class="category-image-container">
                                    <div class="category-image">
                                        <img src="static.php?file=assets/images/icons/c-5.png" alt="icon">
                                    </div>
                                </div>
                                <h5>Honeymoon</h5>
                                <span>Egypt Tours</span>
                    ...
                    <div class="col-xl-2 col-lg-4 col-md-6">
                        <div class="category-content wow fadeInUp" data-wow-delay="00ms" data-wow-duration="2000ms">
                            <div class="category-content-inner">
                                <div class="category-image-container">
                                    <div class="category-image">
                                        <img src="static.php?file=assets/images/icons/c-6.png" alt="icon">
                                    </div>
                                </div>
                                <h5>Holy Family Trail</h5>
                                <span>Egypt Tours</span>
                                <a class='category-btn' href='destination-details.php'><i class="fa-solid fa-angle-right"></i></a>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="common-title">
                            <h5>Deals & Offer</h5>
                            <h3>Egypt Deals, Handpicked!</h3>
                            <div class="deal-icon">
                                <img src="static.php?file=assets/images/icons/doler.png" alt="doler">
                            </div>
                        </div>
                    </div>
                </div>
...
<?php require_once './parts/site-data.php'; ?>
                <div class="deals-slider owl-carousel owl-theme">
                    <?php foreach (array_slice($KE_TOURS, 0, 6) as $t): ?>
                    <div class="deals-content">
                        ...
                        <div class="deals-info">
                            <ul>
                                ...
                                <li><?php echo $t['days']; ?> <span>On Request</span></li>
                            </ul>
                            <a class='deals-info-link' href='tour-details.php'><?php echo $t['title']; ?></a>
                            <p><i class="flaticon-map"></i> <?php echo $t['loc']; ?></p>
                        </div>
                    </div>
                    <?php endforeach; ?>
                            </div>
        ...
        <!-- video -->
        <section class="video">
            <div class="pattern-layer" style="background-image: url(static.php?file=assets/images/shape/destination-map.png);"></div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="video-container">
                            <div class="video-image">
                                <img src="static.php?file=assets/images/egypt/karnak.jpg" alt="image">
                            </div>
                            <div class="video-content wow fadeInLeftBig" data-wow-delay="00ms" data-wow-duration="1500ms">
                                <p>Licensed & Professional</p>
                                <h5>Trusted since 2005 by <span>50,000+</span> happy travelers</h5>
                                <div class="video-info">
                                    <img src="static.php?file=assets/images/icons/destination-icon.png" alt="image">
                                    <ul>
                                        <li>100%</li>
        ...
        <section class="destination">
            <div class="destination-icon">
                <img src="static.php?file=assets/images/icons/plan.png" alt="icon">
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="align-title">
                            <h5>All for Egypt</h5>
                            <h3>Where Will You Go in Egypt?</h3>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="destination-container">
                            <div class="destination-image">
                                <a href='destination-details.php'><img src="static.php?file=assets/images/egypt/pyramids-giza.jpg" alt="image"></a>
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="destination-container mb-24">
                            <div class="destination-image">
                                <a href='destination-details.php'><img src="static.php?file=assets/images/egypt/luxor-temple.jpg" alt="image"></a>
                            </div>
                        ...
                        <div class="destination-container">
                            <div class="destination-image">
                                <a href='destination-details.php'><img src="static.php?file=assets/images/egypt/sharm.jpg" alt="image"></a>
                            </div>
            ...
            <div class="testimonial-container wow fadeInLeftBig" data-wow-delay="00ms" data-wow-duration="2000ms">
                <div class="testimonials-carousel owl-carousel owl-theme">
                    <div class="testimonial-content">
                        ...
                        <p>“ From the pyramids to our Nile cruise, everything ran like clockwork. The guides were brilliant and the private van always on time. Best-organized trip we have ever taken. ”</p>
                    ...
                    <div class="testimonial-content">
                        ...
                        <h5>#Happy Customer</h5>
                        <h4>What Our Customer's Say</h4>
                        <p>“ King Edward planned our honeymoon in Hurghada plus two cruise nights — flawless transfers, lovely hotels and a sunset felucca we will never forget. ”</p>
                        <div class="testimonial-info">
                    ...
                    <div class="testimonial-content">
                        ...
                        <h5>#Happy Customer</h5>
                        <h4>What Our Customer's Say</h4>
                        <p>“ Professional from the first email to the last goodbye at Cairo airport. Abu Simbel at sunrise was worth every mile. Shukran, King Edward Travel! ”</p>
                        <div class="testimonial-info">
        ...
        <!-- group band -->
        <?php include './parts/group-band.php'?>
        <!-- news letter -->
                    ...
                    <div class="col-lg-6">
                        <div class="news-letter-container">
                            <div class="news-letter-container-inner">
                                ...
                                <form>
                                    <input type="email" placeholder="Your email address" class="email" aria-label="Email address">
                                    <a href="contact.php" class="read-more">Subscribe</a>
                                </form>
                                <div class="newsletter-slider owl-carousel owl-theme">
                                    <div class="newsletter-slider-image trust-badge"><i class="fa-solid fa-certificate"></i> License 1311 — Since 2005</div>
                                    <div class="newsletter-slider-image trust-badge"><i class="fa-solid fa-users"></i> 50,000+ Happy Travelers</div>
                                    <div class="newsletter-slider-image trust-badge"><i class="fa-solid fa-bus"></i> Own A/C Fleet + Egypt Limo</div>
                                    <div class="newsletter-slider-image trust-badge"><i class="fa-solid fa-star"></i> 4.9 Average Rating</div>                            </div>
                        </div>
                    </div>

                    <div class="col-lg-6">
                        <div class="news-letter-image wow fadeInUp" data-wow-delay="00ms" data-wow-duration="2000ms">
                            <img src="static.php?file=assets/images/egypt/aswan-nile.jpg" alt="image">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="blog-content wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1000ms">
                            <div class="blog-image">
                                <a href='blog-details.php'><img src="static.php?file=assets/images/egypt/nile-cruise.jpg" alt="image"></a>
                            </div>
                            <div class="blog-info">
                                <div class="footer-info">
                                    <ul>
                                        <li><i class="fa-regular fa-user"></i> King Edward Team</li>
                                        <li><i class="fa-regular fa-calendar"></i> <span> 12 / 12 / 2023</span></li>
                                    </ul>
                                    <a class='blog-title' href='blog-details.php'>Nile Cruise: 3 Nights or 4? How to Choose</a>
                                    <p>Luxor→Aswan or Aswan→Luxor? Cabins, locks, temples and the Abu Simbel question — explained.</p>
                    ...
                    <div class="col-lg-4">
                        <div class="blog-content wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="blog-image">
                                <a href='blog-details.php'><img src="static.php?file=assets/images/egypt/pyramids-giza.jpg" alt="image"></a>
                            </div>
                            <div class="blog-info">
                                <div class="footer-info">
                                    <ul>
                                    ...
                                    <a class='blog-title' href='blog-details.php'>First Time in Cairo: Pyramids in One Perfect Day</a>
                                    <p>Giza, Sphinx, Grand Egyptian Museum and Khan El Khalili — the ideal order plus lunch stop.</p>
                                    <a href='blog-details.php'>Read More</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4">
                        <div class="blog-content wow fadeInUp" data-wow-delay="00ms" data-wow-duration="2000ms">
                            <div class="blog-image">
                                <a href='blog-details.php'><img src="static.php?file=assets/images/egypt/luxor-balloon.jpg" alt="image"></a>
                            </div>
                            <div class="blog-info">
                                <div class="footer-info">
                                    <ul>
                                    ...
                                    <a class='blog-title' href='blog-details.php'>Luxor at Sunrise: Balloons Over the Valley of Kings</a>
                                    <p>What the dawn flight really looks like, what it costs and how we book your slot.</p>
                                    <a href='blog-details.php'>Read More</a>
                                </div>
                            </div>
                        </div>
