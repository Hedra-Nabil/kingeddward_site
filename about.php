...
<?php $title='About King Edward Travel — All for Egypt (Est. 2005)'?>
...
<body>
   ...
   <?php include './parts/preloader.php'?>   
        ...
        <?php $header_class='main-header style-one common-header'; $nav_active='about'; include './parts/header.php'?>
   ...
   <?php include './parts/mobile-menu.php'?>   
    ...
    <!-- Breadcrumb Section -->
    <?php 
       $mainHeading='All for Egypt — since 2005';
       $subHeading='About King Edward Travel';
    ?>
   <?php include './parts/breadcrumb.php'?>   
        ...
        <section class="home-two-about about-page">
            <div class="home2-about-icon1">
                <img src="static.php?file=assets/images/icons/home2-about-icon1.png" alt="">
            </div>
            ...
            <div class="home2-about-icon3">
                <img src="static.php?file=assets/images/icons/home2-about-icon3.png" alt="">
            </div>
            <div class="home-two-pattern-layer" style="background-image: url(static.php?file=assets/images/shape/home-about-map.png);"></div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-5">
                        <div class="common-title">
                            <h5>About King Edward Travel</h5>
                            <h3>Professional planners for your Egypt vacation</h3>
                        </div>
                        <div class="home-two-about-content">
                            <p>“ <strong>King Edward Travel</strong> is an extensive travel agency offering all kinds of services for tourism in Egypt. An official agency under License No. 1311 since 2005, we handle incoming FIT, groups, incentives, conferences and corporate business. ”</p>
                            <p>We own a fleet of elegant air-conditioned buses in various models and capacities, and our highly experienced tour managers provide full information and the best offers. Our main aim is presenting the best image of our beautiful country — Egypt with its history, monuments, civilization, people, traditions and culture.</p>
                        </div>
                        <div class="home-two-about-list">
                            <ul>
                                <li>Official agency — License 1311 since 2005 </li>
                                <li>FIT, groups, incentives, conferences & corporate</li>
                                <li>Own fleet: MAN & Mercedes buses, Mitsubishi & Toyota Coaster, Hiace & Hyundai H1</li>
                                <li>Nile cruises, Cairo, Luxor, Aswan & Red Sea experts</li>
                            </ul>
                        </div>
                    ...
                    <div class="col-lg-6 offset-lg-1">
                        <div class="about-right-image about-right-image-top">
                            <img src="static.php?file=assets/images/egypt/pyramids-giza.jpg" alt="photo">
                        </div>
                        <div class="row">
                            <div class="col-lg-6 pr-0">
                                <div class="about-right-image about-right-image-bottom">
                                    <img src="static.php?file=assets/images/egypt/karnak.jpg" alt="photo">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="about-right-image about-right-image-bottom">
                                    <img src="static.php?file=assets/images/egypt/aswan-nile.jpg" alt="photo">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="align-title">
                            <h5>Our People</h5>
                            <h3>Meet the King Edward Team</h3>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="tour-guide-container wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1000ms">
                            <div class="tour-guid-image">
                                <span class="testimonial-initial team-initial">A</span>
                            </div>
                            <div class="tour-guid-content">
                                <span>King Edward Team</span>
                                <a href='tour-guide.php'>Ahmed El-Masry</a>
                                <p><strong>Senior Tour Manager.</strong> 20 years crafting Egypt itineraries for FIT, groups and incentives.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="tour-guide-container wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="tour-guid-image">
                                <span class="testimonial-initial team-initial">M</span>
                            </div>
                            <div class="tour-guid-content">
                                <span>King Edward Team</span>
                                <a href='tour-guide.php'>Mona Hassan</a>
                                <p><strong>Egyptologist Guide.</strong> Brings Karnak, Giza and the Valley of the Kings to life in 3 languages.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="tour-guide-container wow fadeInUp" data-wow-delay="00ms" data-wow-duration="2000ms">
                            <div class="tour-guid-image">
                                <span class="testimonial-initial team-initial">K</span>
                            </div>
                            <div class="tour-guid-content">
                                <span>King Edward Team</span>
                                <a href='tour-guide.php'>Karim Adel</a>
                                <p><strong>Red Sea Specialist.</strong> Diving and snorkeling trips in Sharm and Hurghada, PADI coordination.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="tour-guide-container wow fadeInUp" data-wow-delay="00ms" data-wow-duration="2500ms">
                            <div class="tour-guid-image">
                                <span class="testimonial-initial team-initial">H</span>
                            </div>
                            <div class="tour-guid-content">
                                <span>King Edward Team</span>
                                <a href='tour-guide.php'>Heba Ibrahim</a>
                                <p><strong>Customer Care.</strong> Your 24/7 contact on tour — WhatsApp support from landing to takeoff.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="tour-guide-container wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1000ms">
                            ...
                            <div class="tour-guid-content">
                                <span>King Edward Team</span>
                                <a href='tour-guide.php'>Mostafa Nabil</a>
                                <p><strong>Head Driver — Fleet.</strong> Leads our drivers across 15 A/C vehicles, from Hiace vans to 50-seat coaches.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="tour-guide-container wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="tour-guid-image">
                                <span class="testimonial-initial team-initial">S</span>
                            </div>
                            <div class="tour-guid-content">
                                <span>King Edward Team</span>
                                <a href='tour-guide.php'>Sara Fouad</a>
                                <p><strong>Groups & Conferences.</strong> Corporate travel, conferences and incentive programs across Egypt.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="tour-guide-container wow fadeInUp" data-wow-delay="00ms" data-wow-duration="2000ms">
                            <div class="tour-guid-image">
                                <span class="testimonial-initial team-initial">O</span>
                            </div>
                            <div class="tour-guid-content">
                                <span>King Edward Team</span>
                                <a href='tour-guide.php'>Omar Khalil</a>
                                <p><strong>Nile Cruise Expert.</strong> Knows every deck from Luxor to Aswan and across Lake Nasser.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="tour-guide-container wow fadeInUp" data-wow-delay="00ms" data-wow-duration="2500ms">
                            <div class="tour-guid-image">
                                <span class="testimonial-initial team-initial">L</span>
                            </div>
                            <div class="tour-guid-content">
                                <span>King Edward Team</span>
                                <a href='tour-guide.php'>Layla Samy</a>
                                <p><strong>Reservations.</strong> Fast quotes and tailor-made offers — replies within 24 hours.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="instagram-title">
                            <h3><i class="fa-brands fa-instagram"></i> Egypt Moments</h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="instagram-container">
                <div class="instagram-content">
                    <div class="instagram-image">
                        <img src="static.php?file=assets/images/egypt/pyramids-giza.jpg" alt="image">
                    </div>
                    <div class="instagram-overlay">
                      <div class="instagram-icon"><a href="static.php?file=assets/images/egypt/pyramids-giza.jpg" class="lightbox-image" data-fancybox="gallery"><i class="fa-brands fa-instagram"></i></a></div>
                    </div>
                </div>
                <div class="instagram-content">
                    <div class="instagram-image">
                    ...
                    <div class="instagram-overlay">
                      <div class="instagram-icon"><a href="static.php?file=assets/images/egypt/karnak.jpg" class="lightbox-image" data-fancybox="gallery"><i class="fa-brands fa-instagram"></i></a></div>
                    </div>
                </div>
                <div class="instagram-content">
                    <div class="instagram-image">
                    ...
                    <div class="instagram-overlay">
                      <div class="instagram-icon"><a href="static.php?file=assets/images/egypt/aswan-nile.jpg" class="lightbox-image" data-fancybox="gallery"><i class="fa-brands fa-instagram"></i></a></div>
                    </div>
                </div>
                <div class="instagram-content hide">
                    <div class="instagram-image">
                        <img src="static.php?file=assets/images/egypt/sharm.jpg" alt="image">
                    </div>
                    <div class="instagram-overlay">
                      <div class="instagram-icon"><a href="static.php?file=assets/images/egypt/sharm.jpg" class="lightbox-image" data-fancybox="gallery"><i class="fa-brands fa-instagram"></i></a></div>
                    </div>
                </div>
                <div class="instagram-content hide">
                    <div class="instagram-image">
                        <img src="static.php?file=assets/images/egypt/luxor-balloon.jpg" alt="image">
                    </div>
                    <div class="instagram-overlay">
                      <div class="instagram-icon"><a href="static.php?file=assets/images/egypt/luxor-balloon.jpg" class="lightbox-image" data-fancybox="gallery"><i class="fa-brands fa-instagram"></i></a></div>
                    </div>
                </div>
                <div class="instagram-content hide">
                    <div class="instagram-image">
                        <img src="static.php?file=assets/images/egypt/hurghada.jpg" alt="image">
                    </div>
                    <div class="instagram-overlay">
                      <div class="instagram-icon"><a href="static.php?file=assets/images/egypt/hurghada.jpg" class="lightbox-image" data-fancybox="gallery"><i class="fa-brands fa-instagram"></i></a></div>
                    </div>
                </div>
            </div>
        </section>
